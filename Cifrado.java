...
public class Cifrado {
    // Metodo de Destino para convertir nemonicos equivalente en binario
    public static String dest(String strDest){
        return switch (strDest ){
            ...
            default -> "Destinacion Invalida"; 
        };
    }
    
    //Con el siguiente metodo convertiremos calculos nemonicos a binario
      ...
      public static String comp(String strComp) {
        ...
        return switch (strComp) {
          ...
          default -> "Conversion Invalida, no coincide";
        };
      }
      
      // Los metodos de salto a binario
